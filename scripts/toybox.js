...
function reEnable(index) {
  ...
  items[index].domElement.style.display = 'grid'; // het laatste item bleef bij 'initial' en in mijn geval breekt dat de styling. daarom heb ik display veranderd naar 'flex'
